class RealProperty:
    ...
    def price_difference(self, compared_to):
        house_1_price = self.square_metres * self.price_per_sqm
        house_2_price = compared_to.square_metres * compared_to.price_per_sqm
        return abs(house_1_price - house_2_price)
    
    def more_expensive(self, compared_to):
        house_1_price = self.square_metres * self.price_per_sqm
        house_2_price = compared_to.square_metres * compared_to.price_per_sqm
        if house_1_price > house_2_price:
            return True
        else:
            return False
